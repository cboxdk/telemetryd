...
```bash
TELEMETRYD_VERSION=0.13.2 sh install.sh
...
```bash
sudo dpkg -i telemetryd_0.13.2_amd64.deb
...
cosign verify-blob \
  ...
  --certificate-identity "https://github.com/cboxdk/telemetryd/.github/workflows/release.yml@refs/tags/v0.13.2" \
