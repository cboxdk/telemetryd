...
```bash
TELEMETRYD_VERSION=0.14.1 sh install.sh
...
```bash
sudo dpkg -i telemetryd_0.14.1_amd64.deb
...
cosign verify-blob \
  ...
  --certificate-identity "https://github.com/cboxdk/telemetryd/.github/workflows/release.yml@refs/tags/v0.14.1" \
