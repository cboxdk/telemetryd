...
python -m sigstore verify identity \
  ...
  --cert-identity "https://github.com/cboxdk/telemetryd/.github/workflows/release.yml@refs/tags/v0.43.0" \
  --cert-oidc-issuer "https://token.actions.githubusercontent.com" \
  SHA256SUMS
```

**This works from v0.43.0 onward.** Earlier releases were signed into cosign's own older
